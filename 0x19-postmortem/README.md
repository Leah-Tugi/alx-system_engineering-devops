...
Upon the release of the System Engineering & DevOps project 0x19,
approximately 00:07 East African Time (EAT), an outage occurred on an isolated
...
Bug debugger Leah.M encountered the issue upon opening the project and being, well, instructed to
...
[0-strace_is_your_friend.pp](https://github.com/leah-tugi/alx-system_engineering-devops/blob/master/0x17-web_stack_debugging_3/0-strace_is_your_friend.pp)
